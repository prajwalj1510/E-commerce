...
const Collection = () => {
  ...
  // Without these, works when load time
  // useEffect(()=>{
  ...
  const applyFilter = () => {
    ...
    let productsCopy = products.slice() ; // Copy array 
    ...
    // Checking for particular Sub Category
    if(subCategory.length > 0) {
      productsCopy = productsCopy.filter(item => subCategory.includes(item.subCategory))
    }

    setFilterProducts(productsCopy) // Loads products even if categories or subcategories are untick
